...
def create_network_graph_tool() -> StructuredTool:
    ...
    return StructuredTool.from_function(
        ...
        description=(
            ...
            "analysis. Use this when questions involve P2P money flow patterns, "
            "circular transactions, suspicious sender-receiver relationships, "
            "network structure, or graph-based fraud detection. This tool exclusively "
            "analyzes P2P transactions — it automatically filters to "
            "transaction_type == 'P2P' before building the graph. For non-P2P "
            "transaction analysis, use other tools. Input: graph_analysis_type "
