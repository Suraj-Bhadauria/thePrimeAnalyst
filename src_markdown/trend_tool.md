...
def create_trend_tool() -> StructuredTool:
    ...
    return StructuredTool.from_function(
        ...
        description=(
            ...
            "smoothing. Supports segmented_trend with any segment_column (sender/receiver "
            "bank/age_group, merchant_category, device_type, network_type, day_of_week, "
            "is_weekend) and filters on any column. "
            "Input: trend_type (string: hourly_trend, daily_trend, "
